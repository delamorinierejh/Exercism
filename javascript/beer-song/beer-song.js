function BeerSong(){
  ...
  this.verse = function(number){
    ...
    var firstBit = `${number} bottle${pluralOne} of beer on the wall, ${typeof number === 'number' ? number : number.toLowerCase()} bottle${pluralOne} of beer.\n`

    var secondBit = `Take ${itOne} down and pass it around, ${secondNum} bottle${pluralTwo} of beer on the wall.\n`;
